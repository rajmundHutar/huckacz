<?php
// source: D:\www\hucka.cz\app\presenters/templates/@layout.latte

class Template202262296b4bf3ed62186e830cad9944 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f0091bb44f', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb47c1e4b09d_head')) { function _lb47c1e4b09d_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb7ad9b035a6_scripts')) { function _lb7ad9b035a6_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
